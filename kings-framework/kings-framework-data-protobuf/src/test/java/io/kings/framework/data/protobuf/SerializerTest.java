 ...
 * <p>
 * unit
 * compare the jdk kryo and protobuf
 * 分别对以上三种方式进行测试 从序列化后的字节长度和耗时两个层面来对比如下：
 * <p>
 * serialization starting!!!!!======>>>
 * proto_stuff serialized passed,data length:140
 * proto_stuff deserialize passed, cut: 67/ms
 * serialization end........
 * <p>
 * serialization starting!!!!!======>>>
 * jdk serialized passed,data length:530
 * jdk deserialize passed, cut: 16/ms
 * serialization end........
 * <p>
 * serialization starting!!!!!======>>>
 * kryo serialized passed,data length:254
 * kryo deserialize passed, cut: 87/ms
 * serialization end........
 * </p>
 * serialization starting!!!!!======>>>
 * proto_stuff serialized passed,data length:140
 * proto_stuff deserialize passed, cut: 61/ms
 * serialization end........
 * <p>
 * serialization starting!!!!!======>>>
 * jdk serialized passed,data length:530
 * jdk deserialize passed, cut: 15/ms
 * serialization end........
 * <p>
 * serialization starting!!!!!======>>>
 * kryo serialized passed,data length:254
 * kryo deserialize passed, cut: 92/ms
 * serialization end........
 * 综上所述 单次jdk自带效率最高 但是多次或大量序列化时情况可能就不是这样了
 * 同时proto stuff在空间上的优势也比较明显 因此可根据实际场景选择可是的序列化器
 * 更多参数对比可以参考三方多面测试
 * * * ========>>>
...
public class SerializerTest {
    ...
    public void after() throws SerializeException {
        ...
        log.debug(property + " deserialize passed, cut: " + (System.currentTimeMillis() - start) + "/ms");
