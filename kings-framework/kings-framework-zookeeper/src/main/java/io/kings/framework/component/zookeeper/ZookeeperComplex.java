...
public interface ZookeeperComplex<K, V> extends Zookeeper {
     ...
     */
    KingsZookeeper inAsync(Consumer<ZookeeperAsync<K, V>> action, ZookeeperAsyncCallback<K, V> callback,
     ...
     */
    KingsZookeeper registerPathWatcher(K path, ZookeeperPathWatcher<K, V> pathListener, Serializer serializer)
            throws ZookeeperWatcherException;
     ...
     * @see this#registerPathAndChildrenWatcher(Object, boolean, boolean, int, ExecutorService, ZookeeperPathAndChildrenWatcher)
     */
    default KingsZookeeper registerPathAndChildrenWatcher(K path, ZookeeperPathAndChildrenWatcher<K, V> watcher,
                                                          Serializer serializer)
            throws ZookeeperWatcherException {
        try {
