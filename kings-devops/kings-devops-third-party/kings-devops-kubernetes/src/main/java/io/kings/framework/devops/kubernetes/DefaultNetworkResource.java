...
class DefaultNetworkResource extends
    AbstractKubernetesResource<KubernetesClient, NetworkResource> implements NetworkResource {
    ...
    static class DefaultServiceResource extends
        AbstractKubernetesResource<KubernetesClient, ServiceResource> implements ServiceResource {
